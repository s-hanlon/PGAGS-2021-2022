(function() { // module pattern
  ...
  var MAP      = { tw: 64, th: 48 },
      ...
      COLOR    = { RED: 'gold', GREEN: '#6e4004', BLUE: '#087ca6', WHITE: '#FFFFFF', PURPLE: '#10c434', GREY: '#6e4004', SLATE: '#ea00ff', GOLD: 'gold' },
      COLORS   = [ COLOR.RED, COLOR.GREEN, COLOR.BLUE, COLOR.WHITE, COLOR.PURPLE ],
      KEY      = { SPACE: 32, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40, W: 87, A: 65, D: 68, S:83 };
  ...
  function onkey(ev, key, down) {
    switch(key) {
      ...
      case KEY.UP: player.gravity  = -1* (Math.abs(player.gravity)); ev.preventDefault(); return false;
      case KEY.SPACE: player.gravity  = -1* Math.abs(player.gravity); ev.preventDefault(); return false;
      case KEY.DOWN: player.gravity  = Math.abs(player.gravity); ev.preventDefault(); return false;
      case KEY.A:  player.left  = down; ev.preventDefault(); return false;
      case KEY.D: player.right = down; ev.preventDefault(); return false;
      case KEY.W: player.gravity  = -1* (Math.abs(player.gravity)); ev.preventDefault(); return false;
      case KEY.S: player.gravity  = Math.abs(player.gravity); ev.preventDefault(); return false;
